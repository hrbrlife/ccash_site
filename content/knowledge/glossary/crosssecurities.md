...
description: "CCASH CrossSecurities are bonds, shares, or RWA tokens that can be held on-chain (Solana) or via traditional bank/brokerage custody (ISIN-bearing) - and."
ogImage: "/og-image.png"
keywords: ["crosssecurities", "glossary", "CCASH", "bonds", "shares", "rwa", "tokens", "held"]
stylesheets:
  - "/css/main.css"
...
relatedTerms:
  ...
  - slug: "custody"
    label: "Custody"
termTitle: "CCASH CrossSecurities"
...
<section class="term-section">
    ...
    <p><strong>CCASH CrossSecurities</strong> are bonds, shares, or RWA (Real World Asset) tokens issued on the CCASH platform that exist in a unique dual-format structure. They can be held either:</p>
    <ul>
