...
description: "An open-source platform for self-hosting web applications, providing OS-level isolation for each application instance (grain) in the CCASH runtime."
...
<section class="term-section">
    ...
    <p>Sandstorm gives CCASH true application isolation without containers or VMs. Each <a href="/knowledge/glossary/grain/">grain</a> is a security boundary - compromise one, and the rest remain unaffected. This is not a policy enforced by configuration; it is a structural property of the runtime.</p>
