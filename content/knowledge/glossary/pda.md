...
description: "A deterministic Solana account address derived from program seeds, used in CCASH for trustless, programmatic state management."
...
<section class="term-section">
    ...
    <p>CCASH uses PDAs extensively across the <a href="/knowledge/glossary/melusina/">Melusina</a> system for critical state accounts:</p>
    <ul>
...
<section class="term-section">
    ...
    <p>The result: every piece of CCASH platform state is stored at a predictable, verifiable, program-controlled address.</p>
</section>
