...
<section class="term-section">
    ...
    <p>The Powerbox is what makes CCASH's security model fundamentally different from every other platform in the industry. In a traditional system, a Broker Portal might have "read access to KYC data" via a database role. That role grants access to <em>all</em> KYC data, for <em>all</em> investors, forever, unless explicitly revoked. One compromised credential and the entire KYC database is exposed.</p>
