...
description: "The application engine layer of CCASH, built on Sandstorm/Melusina OS, providing the grain runtime for all platform applications."
...
<section class="term-section">
    ...
    <p>By standardizing on a single application engine, CCASH achieves consistency across all platform surfaces. New features deploy as new grains - isolated, auditable, and governed by the same capability model that protects every other component.</p>
</section>
