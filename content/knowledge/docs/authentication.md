...
<h2>Authentication Layers</h2>
        <p>CCASH implements a four-layer authentication model. Each layer builds on the one below it. No single layer is sufficient - all four must agree before any operation proceeds. This is not over-engineering; this is what you build when you're responsible for other people's securities.</p>
...
Layer 4: Powerbox Capability        → proves inter-grain authority</code></pre>
        ...
        <h2>Role NFTs</h2>
        <p>The <span class="glossary-term" data-term="melusina">Melusina</span> program mints role-specific NFTs that encode participant authorization. Each is a print edition from the CCASH <span class="glossary-term" data-term="master-nft">Master NFT</span>, carrying role-specific metadata and optional expiration. Every role NFT is recallable - the issuing authority can revoke it at any time.</p>
        <table>
            <thead>
                <tr>
                    <th>Role NFT</th>
