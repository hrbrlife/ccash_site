...
stylesheets:
  ...
  - "/css/pages/docs.css"
heroDesc: "Every NFT and on-chain account on CCASH carries structured metadata - the fields that tell the protocol what a token represents, who holds it, and what rules apply."
draft: false
date: "2026-02-24"
lastmod: "2026-02-24"
sitemap:
...
└── pep_clear:           bool       // Politically exposed person check</code></pre>
        ...
        <p>Each Role NFT is a print edition from the <span class="glossary-term" data-term="master-nft">CCASH Master NFT</span>, carrying role-specific metadata and optional expiration. All Role NFTs are recallable - if a participant's authorization is revoked, their NFT is burned and every instruction that checks for it will immediately fail.</p>
        <table>
            <thead>
                <tr>
                    <th>Role NFT</th>
