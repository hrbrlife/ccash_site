---
title: "Understanding the Graduation Model - Documentation"
type: "doc"
description: "The CCASH graduation model explained — start on shared infrastructure, graduate to your own self-hosted instance."
...
## Understanding the Graduation Model

The graduation model is the core of CCASH's value proposition. It solves a fundamental problem: most platforms either force you to build everything from scratch (expensive, slow) or lock you into a shared platform forever (no control, platform risk).

CCASH offers a different path.
...
When you're ready, you deploy your own self-hosted CCASH instance:
...
The graduation path is not a feature that can be revoked. It is the foundation of the CCASH business model. Any lock-in mechanism — technical, legal, or economic — that makes graduation impractical violates this promise.
