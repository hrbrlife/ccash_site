...
<h2>Overview</h2>
        ...
        <p>The Clearstream Adapter is a Go service that runs as a <span class="glossary-term" data-term="grain">grain</span> or sidecar within the Sandstorm/Melusina OS environment. It handles all communication between the CCASH platform and Clearstream, translating between <span class="glossary-term" data-term="cap-n-proto">Cap'n Proto</span> RPC calls and the SWIFT/ISO messaging formats that Clearstream expects.</p>
...
└── Communication
    ...
    └── Webhook notifications for real-time updates</code></pre>
        ...
        <ol>
            <li><strong>Pull Clearstream positions</strong> - The adapter requests the daily position report from Clearstream for all active ISINs linked to CCASH offerings.</li>
        ...
        <p>The Clearstream Adapter translates between the CCASH <span class="glossary-term" data-term="cap-n-proto">Cap'n Proto</span> schema and the messaging formats that traditional financial infrastructure expects. All messages are validated against their respective schemas before submission.</p>
