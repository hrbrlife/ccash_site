...
type: "guide"
description: "What tokenization is, why it matters, and how CCASH's CrossSecurities architecture creates hybrid on-chain + bankable securities that actually work in."
...
<nav class="guide-nav">
            ...
            <ul>
                ...
                <li><a href="#how-ccash-tokenizes">How CCASH Tokenizes</a></li>
        ...
        <section id="how-ccash-tokenizes" class="guide-section">
            <h2>How CCASH Tokenizes</h2>
            <p>Most tokenization platforms make you choose: on-chain <em>or</em> traditional. CCASH refuses that choice. Our <span class="glossary-term" data-term="crosssecurities">CrossSecurities</span> architecture delivers both simultaneously - a hybrid instrument that is natively on-chain <em>and</em> bankable through traditional infrastructure.</p>
            <h3>The CrossSecurities Architecture</h3>
            <p>Every CCASH security token is deployed through our <code>sails_securities</code> program on Solana, built on the SPL Token-2022 standard with compliance hooks. But here is what makes it different:</p>
            <ul>
            ...
            <p>Every offering on CCASH is issued through a <span class="glossary-term" data-term="wyoming-dao-llc">Wyoming DAO LLC</span> with a <span class="glossary-term" data-term="series-llc">Series LLC</span> structure. Each offering is its own series - legally isolated from every other offering on the platform.</p>
            <ul>
        ...
        <section id="token-lifecycle" class="guide-section">
            ...
            <p>Every CCASH security token follows a defined lifecycle, managed by the <code>sails_securities</code> Solana program. Here is the complete journey from offering creation to conversion:</p>
            <div class="step-card">
        ...
        <section id="asset-types" class="guide-section">
            <h2>Asset Types</h2>
            <p>Tokenization is not limited to one asset class. Any asset that can be structured as a security can be tokenized on CCASH. Here are the primary categories:</p>
            <h3>Equity</h3>
            ...
            <div class="requirement-box">
                <h4>Who Can Tokenize on CCASH?</h4>
                <ul>
            ...
            <table class="comparison-table">
                <tr>
                    ...
                    <th>CCASH Tokenized Securities</th>
                </tr>
                <tr>
        ...
        <section id="getting-started" class="guide-section">
            ...
            <p>Tokenization is not speculative. It is not experimental. It is the inevitable endpoint of a financial system that has been digitizing for fifty years. CCASH is where the digitization becomes complete.</p>
            <h3>For Issuers</h3>
